...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v3.5.3"
  WORKING_DIRECTORY "/Users/ridhamap/monostructure_alpha_signal/hf-microstructure/build/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/ridhamap/monostructure_alpha_signal/hf-microstructure/build/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ridhamap/monostructure_alpha_signal/hf-microstructure/build/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
